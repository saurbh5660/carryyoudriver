                            ...
                            children: [
                              Expanded(
                                child: Row(
                                  ...
                                  spacing: 5,
                                  children: [
                                    Image.asset(Assets.icons.danceClock.path,width: 20,height: 20,color: Colors.black),
                                    Flexible(
                                      child: Text(
                                        '2 Hours',
                                        style: GoogleFonts.poppins(
                              ...
                              Expanded(
                                child: Row(
                                  ...
                                  spacing: 5,
                                  children: [
                                    Image.asset(Assets.icons.danceType.path,width: 20,height: 20,color: Colors.black),
                                    Flexible(
                                      child: Text(
                                        'Hip Hop',
                                        style: GoogleFonts.poppins(
                            ...
                            children: [
                              Expanded(
                                child: Row(
                                  ...
                                  spacing: 5,
                                  children: [
                                    Image.asset(Assets.icons.danceBegineer.path,width: 20,height: 20,color: Colors.black),
                                    Flexible(
                                      child: Text(
                                        'Beginner',
                                        style: GoogleFonts.poppins(
