              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildField("Registration Expiration Date", controller.registrationExpiryController, "YYYY-MM-DD", isDate: true),
                    const SizedBox(height: 20),

                    _buildUploadSection("Insurance Policy", controller.insuranceImage, 3),
                    const SizedBox(height: 20),

                    _buildField("Insurance Expiration Date", controller.insuranceExpiryController, "YYYY-MM-DD", isDate: true, hasCalendarIcon: true),
                    const SizedBox(height: 20),
      ...
      Dialog(
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Image.asset(Assets.icons.checked.path, width: 80, height: 80),
