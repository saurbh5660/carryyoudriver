...
class DriverPrivacyScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      if (controller.privacyContent.value.isEmpty && !controller.isPrivacyLoading.value) {
        controller.fetchLegalContent('privacy_policy');
      }
    });
          ...
          child: Column(
            ...
            children: [
              ...
              Expanded(
                child: Container(
                  ...
                  child: Obx(() {
                    ...
                    final String textToDisplay = controller.privacyContent.value.isNotEmpty
                        ? controller.privacyContent.value
                        : 'Loading Privacy Policy...';

                    return SingleChildScrollView(
                      controller: controller.privacyScrollController,
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          ...
                          Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                Row(
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      child: Text(
                                        "v${controller.privacyVersion.value}",
                                        style: GoogleFonts.montserrat(
                                          fontSize: 11,
                                ...
                                const SizedBox(height: 4),
                                Text(
                                  "Version ${controller.privacyVersion.value}. Effective ${controller.privacyEffectiveDate.value}",
                                  style: GoogleFonts.montserrat(
                                    fontSize: 12,
                          ...
                          if (controller.hasScrolledPrivacy.value) ...[
                            Row(
                              children: [
                ...
                children: [
                  Expanded(
                    child: OutlinedButton.icon(
                      onPressed: () {
                        controller.downloadDocument('Privacy Policy');
                      },
                  ...
                  Expanded(
                    child: OutlinedButton.icon(
                      onPressed: () {
                        controller.emailDocument('Privacy Policy');
                      },
              ...
              Obx(
                () => InkWell(
                  onTap: () {
                    controller.isPrivacyAccepted.value = !controller.isPrivacyAccepted.value;
                  },
                  borderRadius: BorderRadius.circular(8),
                  child: Padding(
                      ...
                      children: [
                        SizedBox(
                          ...
                          child: Checkbox(
                            ...
                            onChanged: (val) {
                              controller.isPrivacyAccepted.value = val ?? false;
                            },
                          ),
                        ),
                        ...
                        Expanded(
                          child: Text(
                            'I have read and agree to the Privacy Policy dated ${controller.privacyEffectiveDate.value}.',
                            style: GoogleFonts.montserrat(
                              fontSize: 14,
                              fontWeight: FontWeight.bold,
                              color: Colors.black,
                ...
                () => SizedBox(
                  ...
                  child: ElevatedButton(
                    style: ElevatedButton.styleFrom(
                      backgroundColor: controller.isPrivacyAccepted.value
                    ...
                    onPressed: controller.isPrivacyAccepted.value
                        ? () => Get.toNamed(AppRoutes.distractedDriving)
                        : null,
                    child: Text(
                      'Accept and continue',
                      style: GoogleFonts.montserrat(
                        fontSize: 16,
                        fontWeight: FontWeight.w600,
                        color: controller.isPrivacyAccepted.value
                            ? Colors.white
