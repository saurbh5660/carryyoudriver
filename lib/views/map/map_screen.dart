...
class _MapScreenState extends State<MapScreen> {
  ...
  Widget _buildActionCircle(IconData icon, Color color,bool isTripStarted) {
    Logger().d("fdsfdsdsgds");
        ...
        if(!isTripStarted){
          Get.toNamed(AppRoutes.chatScreen,
            arguments: {
              ...
              "name": controller.requestBody.value.user?.fullName.toString(),
              "image": controller.requestBody.value.user?.profilePicture
                  .toString(),
            },);
        }else{
